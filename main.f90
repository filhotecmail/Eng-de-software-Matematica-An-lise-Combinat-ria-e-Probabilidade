...
!
! Contexto matemático (lógica de entendimento do problema):
! - Um ID inválido é um número decimal cuja representação é a
!   concatenação de uma sequência de dígitos com ela mesma: S||S.
! - Portanto, IDs inválidos têm número de dígitos par: 2k.
! - Seja k = metade do comprimento e X o inteiro formado pelos
...
!   diretamente via X e k, garantindo eficiência e correção.
! - Em caso de intervalos sobrepostos, N deve ser deduplicado antes da soma.
! ================================================================
